...
Per tant, tot que l’objectiu de Bun és aconseguir la compatibilitat total amb Node.js, actualment és compatible amb molts mòduls, però segueixen treballant per arribar al 💯. 
