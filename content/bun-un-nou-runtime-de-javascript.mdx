...
Per això, de moment, tot i que tinc ganes de començar a utilitzar Bun en algún projecte, em preocuparia de tenir un pla B sota la màniga al desplegar a producció. Ja sabeu, només per si un cas… 😄